        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="text-default">Nama Barang</label>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label> Stok</label>
                        <input type="text" class="form-control" name="stok" id="stok" placeholder="Stok Barang" value="<?= set_value('stok') ?>">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="deskripsi" id="deskripsi" rows="5" placeholder="Masukkan Deskripsi" value="<?= set_value('deskripsi') ?>"></textarea>
                    </div>
                </div>
            </div>
