                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-sm btn-flat btn-primary " data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>">Cek Bukti Bayar</button>
                                        <a href="<?= base_url('pesanan_masuk/proses/' . $value->id_transaksi) ?>" class="btn btn-sm btn-flat btn-dark">Proses</a>
                                    <?php } ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body"><img class="img-fluid pad" src="<?= base_url("assets/bukti_bayar/" . $value->bukti_bayar) ?>" alt="Photo">
                    </div>
    ...
    <div class="modal fade" id="kirim<?= $value->id_transaksi ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('pesanan_masuk/kirim/' . $value->id_transaksi) ?>
                    <table class="table">
                        <tr>
                            <th>Expedisi</th>
                            <th>:</th>
